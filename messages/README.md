...
docker buildx build --platform linux/amd64 --network=host -t registry.deti:5000/egs-ressellr/messages:v1.8 .
docker push registry.deti:5000/egs-ressellr/messages:v1.8
